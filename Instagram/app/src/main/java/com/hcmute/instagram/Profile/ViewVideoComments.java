...
public class ViewVideoComments extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPost.setOnClickListener(v -> {
            if (!mComment.getText().toString().isEmpty()) {
                ...
                Toast.makeText(ViewVideoComments.this, "You can't post a blank comment", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void addNewComment(String newComment) {
        ...
        addCommentNotification(newComment, mVideo.getUser_id(), mVideo.getVideo_id());
    }
